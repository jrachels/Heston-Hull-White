...
//
//TEST_CASE("BASIC COMPILATION/EXECUTE TEST for FD") {
//	
...
//	}
//
//	std::cout << "START OF V ENTRIES \n\n";
//	for (int i = 0; i < 40; ++i) {
//		for (double d : discretization.VCoefficientsByIndex(i)) {
//			std::cout << d << "   ";
//		}
//		std::cout << "\n";
//	}
//
//	std::cout << "START OF R ENTRIES \n\n";
//	for (int i = 0; i < 41; ++i) {
//		for (double d : discretization.RCoefficientsByIndex(i)) {
//			std::cout << d << "   ";
//		}
//		std::cout << "\n";
//	}
//
//	std::cout << interest_curve_ptr->ShortRate();
//
//	//std::cin.ignore();
//
//	heston_hull_white::finite_difference::FiniteDifference< heston_hull_white::finite_difference::examples::CraigSneyd<heston_hull_white::finite_difference::examples::ThreeDimensionalGrid<double>>, \
...
//
//
//	//std::cout << "\n\n" << fd.PriceByIndex<int, int, int>(499, 100, 100, 20) << "\n\n";
//
//	for (int i = 0; i < 40; ++i) {
//		std::cout << "\ni = " << i << "\n";
//		for (int j = 0; j < 40; ++j) {
//			//std::cout << "\n";
//			for (int k = 0; k < 21; ++k) {
//				std::cout << fd.PriceByIndex<int, int, int>(998, i, j, k) << "  ";
//			}
//			std::cout << "j = " << j << "\n";
//		}
//	}
...
//	//		std::cout << "\n";
//	//		for (int j = 0; j < 20; ++j) {
//	//			std::cout << fd.PriceByIndex<int, int, int>(499, i, j, k) << "  ";
//	//		}
//	//		std::cout << "i = " << i << "\n";
//	//	}
//	//}
...
//	//		std::cout << "\n";
//	//		for (int j = 0; j < 20; ++j) {
//	//			std::cout << fd.PriceByIndex<int, int, int>(1, i, j, k) << "      ";
//	//		}
//	//		std::cout << "i = " << i;
//	//	}
//	//}
