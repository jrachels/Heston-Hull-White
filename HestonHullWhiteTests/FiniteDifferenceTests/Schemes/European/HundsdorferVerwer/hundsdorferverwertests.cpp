...
TEST_CASE("Basic Accuracy test for HundsdorferVerwer") {
	...
	heston_hull_white::finite_difference::FiniteDifference< heston_hull_white::finite_difference::examples::HundsdorferVerwer<heston_hull_white::finite_difference::examples::ThreeDimensionalGrid<double>>, \
