...
TEST_CASE("Basic Accuracy test for Douglas") {
	...
	heston_hull_white::finite_difference::FiniteDifference< heston_hull_white::finite_difference::examples::Douglas<heston_hull_white::finite_difference::examples::ThreeDimensionalGrid<double>>, \
