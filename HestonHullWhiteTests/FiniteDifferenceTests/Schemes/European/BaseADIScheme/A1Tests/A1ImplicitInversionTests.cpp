...
TEST_CASE("A1 Inversion Test") {
	...
	heston_hull_white::finite_difference::examples::A1<heston_hull_white::finite_difference::examples::ThreeDimensionalGrid<double>> a1{ discretization };
	
	heston_hull_white::finite_difference::examples::A1ImplicitInversion< heston_hull_white::finite_difference::examples::ThreeDimensionalGrid<double>> a1_implicit_inverter{ a1 , theta, epsilon_t };
	...
	a1_implicit_inverter.SolveSystemInPlace(rhs);
	...
	heston_hull_white::finite_difference::examples::A1<heston_hull_white::finite_difference::examples::ThreeDimensionalGrid<double>> i_minus_theta_times_epsilon_times_a1 = a1;
	a_1_tester.IMinusThetaEpsilonA1(i_minus_theta_times_epsilon_times_a1, theta, epsilon_t);

	i_minus_theta_times_epsilon_times_a1.TransformGridInPlace(lhs);
