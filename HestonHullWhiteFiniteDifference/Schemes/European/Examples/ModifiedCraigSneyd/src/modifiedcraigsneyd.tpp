#ifndef HESTONHULLWHITEFINITEDIFFERENCE_SCHEMES_EUROPEAN_EXAMPLES_MODIFIEDCRAIGSNEYD_SRC_MODIFIEDCRAIGSNEYD_TPP
#define HESTONHULLWHITEFINITEDIFFERENCE_SCHEMES_EUROPEAN_EXAMPLES_MODIFIEDCRAIGSNEYD_SRC_MODIFIEDCRAIGSNEYD_TPP

#include "HestonHullWhiteFiniteDifference/Schemes/European/Examples/ModifiedCraigSneyd/modifiedcraigsneyd.h"

template<typename GridType>
GridType heston_hull_white::finite_difference::examples::ModifiedCraigSneyd<GridType>::Next(const GridType& current_prices) {
...
\
	...
	// line 4
	GridType Y_3_minus_current_prices = Y_3;
	Y_3_minus_current_prices.Subtract(current_prices);
	GridType Y_0_hat = a0_.TransformGrid(Y_3_minus_current_prices);
	Y_0_hat.MultiplyByConstant<double>(epsilon_ * theta_);
	Y_0_hat.Add(Y_0);

	// line 5
	GridType A_0_Y_3 = a0_.TransformGrid(Y_3);
	GridType A_1_Y_3 = a1_.TransformGrid(Y_3);
	GridType A_2_Y_3 = a2_.TransformGrid(Y_3);
	GridType Y_0_tilde = a3->TransformGrid(Y_3);
	Y_0_tilde.Add(A_0_Y_3);
	Y_0_tilde.Add(A_1_Y_3);
	Y_0_tilde.Add(A_2_Y_3);
	Y_0_tilde.Subtract(Line_5_Intermediate);
	Y_0_tilde.MultiplyByConstant<double>(epsilon_ * (.5 - theta_));
	Y_0_tilde.Add(Y_0_hat);
