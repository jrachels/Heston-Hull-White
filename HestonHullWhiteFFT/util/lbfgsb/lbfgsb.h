#ifndef HESTONHULLWHITEFFT_UTIL_LBFGSB_LBFGSB_H
#define HESTONHULLWHITEFFT_UTIL_LBFGSB_LBFGSB_H
...
and it isn't necessary to allocate it in the FuncGrad subroutine.
    ...
    Argonne National Laboratory and NortHullWhiteestern University.
